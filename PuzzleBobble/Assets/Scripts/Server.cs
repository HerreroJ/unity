...
public class Server : MonoBehaviour {
    ...
    private void Update() {
        ...
        switch (recData) {
            ...
            //            break;
            //        case "PARARPALA":
            //            Send("PARARPALA|" + 0, reliableChannel, clients);
            //            break;
            //        case "MOVERPELOTA":
            //            //Debug.Log("MOVERPELOTA" + msg);
            //            Send("MOVERPELOTA|" + velocidadPelota, reliableChannel, clients);
            //            break;

            //        case "PELOTACHOQUEPALAS":
            //            //Debug.Log("MOVERPELOTA" + msg);
            //            Send("PELOTACHOQUEPALAS|" + velocidadPelota, reliableChannel, clients);
            //            break;

            //        case "PELOTACHOQUEFONDO":
            //            //Debug.Log("MOVERPELOTA" + msg);
            //            Send("PELOTACHOQUEFONDO|" + velocidadPelota, reliableChannel, clients);
            //            break;

            //        case "PELOTACHOQUESUELOTECHO":
            //            //Debug.Log("MOVERPELOTA" + msg);
            //            Send("PELOTACHOQUESUELOTECHO|" + velocidadPelota, reliableChannel, clients);
            //            break;
